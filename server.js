...
const options = {
  key: fs.readFileSync(path.resolve('/home/ben/ssl-cert/1741685_woyaotest.com.key')),
  cert: fs.readdirSync(path.resolve('/home/ben/ssl-cert/1741685_woyaotest.com.pem'))
};
